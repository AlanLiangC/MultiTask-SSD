...
class Surface_PW_feature(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # surface_feature = surface_feature[sampled_idx_list.long()]
...
class Generate_center(nn.Module):
    ...
    def get_training_loss(self):
        ...
        lattent_loss = torch.mean(self.kl_divergence(normal_dist, dist_prior))*1e-2
        ...
        lattent_loss2 = torch.mean(self.kl_divergence(normal_dist, dist_prior))*1e-2
